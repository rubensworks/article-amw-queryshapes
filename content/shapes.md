...
Afterwards, we demonstrate the expressivity of FSS by expressing all well known LDF languages using FSS.
...
This demonstrates that FSS is sufficiently expressive to represent all LDF types that are known so far.
...
which allows bindings to be passed.
